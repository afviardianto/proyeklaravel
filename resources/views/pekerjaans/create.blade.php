...
<div class="container-fluid">
        <div class="row mt-sm-4">
            <div class="col-12 col-md-12 col-lg-4">
                <div class="card">
                    <form method="post" class="needs-validation" enctype="multipart/form-data" action="{{ route('pekerjaans.store') }}">
                    @csrf
                        <div class="card-header">
                            <h6>Tambah Pekerjaan</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <select name="tipe_pekerjaan_id" class="form-control">
                                        ...
                                        <option value="{{ $tipepekerjaan->id}}">{{ $tipepekerjaan->nama_tipe_pekerjaan}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="keterangan_pekerjaan" id="keterangan_pekerjaan" class="form-control" value="{{old('keterangan_pekerjaan')}}">
